      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <Icons.Instagram className="w-5 h-5 text-slate-500 dark:text-white/70 hover:text-brand-600 dark:hover:text-brand-500 cursor-pointer transition-colors" />
              <Icons.Linkedin className="w-5 h-5 text-slate-500 dark:text-white/70 hover:text-brand-600 dark:hover:text-brand-500 cursor-pointer transition-colors" />
              <Icons.Mail className="w-5 h-5 text-slate-500 dark:text-white/70 hover:text-brand-600 dark:hover:text-brand-500 cursor-pointer transition-colors" />
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-600 dark:text-white/60">
              <li><Link to="/about" className="hover:text-brand-600 dark:hover:text-brand-500 cursor-pointer transition-colors">Our Story</Link></li>
              <li><Link to="/projects" className="hover:text-brand-600 dark:hover:text-brand-500 cursor-pointer transition-colors">Residences</Link></li>
              <li><Link to="/services" className="hover:text-brand-600 dark:hover:text-brand-500 cursor-pointer transition-colors">Lifestyle</Link></li>
              <li><Link to="/insights" className="hover:text-brand-600 dark:hover:text-brand-500 cursor-pointer transition-colors">Insights</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-600 dark:text-white/60">
              <li className="flex items-start gap-2">
                <Icons.MapPin className="w-4 h-4 text-brand-600 dark:text-brand-500 mt-1 shrink-0" /> 
              ...
              <li className="flex items-center gap-2">
                <Icons.Phone className="w-4 h-4 text-brand-600 dark:text-brand-500 shrink-0" /> 
                <a href="tel:+971561705995" className="hover:text-brand-600 dark:hover:text-brand-500 transition-colors">
                  +971-561705995
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Icons.Mail className="w-4 h-4 text-brand-600 dark:text-brand-500 shrink-0" /> 
                <a href="mailto:info@ridhirarealty.com" className="hover:text-brand-600 dark:hover:text-brand-500 transition-colors">
          ...
          <div>
            ...
            <div className="flex border-b border-slate-300 dark:border-white/20 pb-2">
              ...
              <button className="text-brand-600 dark:text-brand-500 uppercase text-xs tracking-widest hover:text-slate-900 dark:hover:text-white transition-colors">Join</button>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-slate-200 dark:border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 dark:text-white/30">
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4 text-center md:text-left">
            ...
            <p>Design and Develop by <a href="https://lexonit.com" target="_blank" rel="noopener noreferrer" className="hover:text-brand-600 dark:hover:text-brand-500 transition-colors">Lexonit.com</a></p>
          </div>
