...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <h2 className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 text-white font-bold transition-opacity duration-300 font-serif text-xl tracking-wide">
        {product.title}
      </h2>
    </motion.div>
  );
