...
import { CometCard } from "../components/ui/AceternityUI";
...
const AboutPage: React.FC = () => {
  ...
  const coreValues = [
    {
      title: "Trust",
      description:
        "Every interaction built on honesty, clarity, and accountability.",
    ...
    },
    {
      title: "Technology",
      description:
        "Leveraging analytics, automation, and AI to empower decisions.",
  ...
  const teamExpertise = [
    { title: "Market Analytics & Forecasting", icon: Icons.TrendingUp },
    { title: "Real-Estate Finance & Planning", icon: Icons.Banknote },
    { title: "Legal Compliance (RERA/DLD)", icon: Icons.FileCheck },
    { title: "AI-Driven Portfolio Advisory", icon: Icons.DataDriven },
    { title: "Golden Visa & Residency Strategy", icon: Icons.LegalVisa },
  ];

  const promises = [
    { text: "Actionable market intelligence before recommendations", icon: Icons.DataDriven },
    { text: "Zero hidden fees & full documentation transparency", icon: Icons.Eye },
    { text: "RERA & DLD-verified projects only", icon: Icons.ShieldCheck },
    { text: "Education through each stage", icon: Icons.Intelligence },
    { text: "Long-term ROI focus over quick sales", icon: Icons.TrendingUp },
  ];
  ...
  return (
    <main className="bg-white dark:bg-luxury-black min-h-screen transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-12">
          ...
          >
            <div className="space-y-4 text-slate-600 dark:text-white/70 text-lg leading-relaxed">
              <h2
                className="text-2xl uppercase tracking-widest font-semibold block mb-2"
                style={{ color: "goldenrod" }}
              >
                About Ridhira Realty{" "}
              </h2>
              <h2 className="text-3xl md:text-4xl font-semibold text-slate-900 dark:text-white">
                Knowledge First. Trust Always.
              </h2>

              <p>
                Ridhira Realty LLC was founded with one vision — to redefine how
                property investment is experienced. We believe that real estate
                decisions should be made through knowledge, not hype.
              </p>
              <p>
                With a foundation rooted in transparency, advisory excellence,
                and technology-driven insights, Ridhira helps clients identify
                the right opportunities and achieve sustainable returns.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
            ...
            >
              <CometCard className="h-full">
                <div className="bg-amber-50 dark:bg-amber-900/20 p-8 rounded-xl border-2 border-amber-500/50 dark:border-amber-500/30 h-full">
                  <div className="flex items-center gap-3 mb-4">
                    <Icons.Briefcase className="w-6 h-6" style={{ color: 'goldenrod' }} />
                    <h3 className="text-2xl  text-slate-900 dark:text-white">
                      Mission
                    </h3>
                  </div>
                  <p className="text-slate-700 dark:text-white/80">
                    To educate and empower investors through data-driven real estate
                    intelligence.
                  </p>
                </div>
              </CometCard>
            ...
            >
              <CometCard className="h-full">
                <div className="bg-amber-50 dark:bg-amber-900/20 p-8 rounded-xl border-2 border-amber-500/50 dark:border-amber-500/30 h-full">
                  <div className="flex items-center gap-3 mb-4">
                    <Icons.Eye className="w-6 h-6" style={{ color: 'goldenrod' }} />
                    <h3 className="text-2xl  text-slate-900 dark:text-white">
                      Vision
                    </h3>
                  </div>
                  <p className="text-slate-700 dark:text-white/80">
                    To be the UAE's most trusted name in intelligent property
                    investment.
                  </p>
                </div>
              </CometCard>
          ...
          <SectionWrapper>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
              {coreValues.map((val, idx) => (
                ...
                >
                  <CometCard className="h-full">
                    <div className="bg-white dark:bg-black/40 border border-slate-200 dark:border-white/10 p-8 rounded-xl hover:border-amber-500/50 transition-all duration-300 shadow-sm dark:shadow-none group cursor-pointer h-full">
                      <motion.div 
                        className="w-16 h-16 rounded-full border-2 border-amber-500/50 bg-amber-500/10 flex items-center justify-center mb-6 transition-all duration-300"
                        whileHover={{ 
                          scale: 1.15,
                          boxShadow: "0 0 30px rgba(218, 165, 32, 0.4), 0 0 50px rgba(255, 215, 0, 0.2)",
                        }}
                      >
                        <val.icon className="w-8 h-8" style={{ color: 'goldenrod' }} strokeWidth={1.6} />
                      </motion.div>
      ...
      <SectionWrapper className="py-24 bg-white dark:bg-luxury-black transition-colors duration-300">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4" style={{ color: 'goldenrod' }}>
                What Sets Us Apart
              </h2>
              <h2 className="text-xl  text-slate-900 dark:text-white mb-8">
                Unlike listing-driven brokers, we focus on data, depth and
                direction.
              </h2>
               <h3 className="text-lg text-slate-900 dark:text-white mb-8 font-semibold">
                Differentiators
              </h3>
              ...
              <div className="mt-8 p-6 border-l-2 border-brand-500 bg-slate-50 dark:bg-white/5 italic text-slate-800 dark:text-white/90  rounded-r-lg">
                “We don’t just match you with properties — we match you with
                possibilities.”
              </div>
            </div>
            <motion.div
      ...
      <div className="py-24 bg-slate-50 dark:bg-luxury-charcoal container-fluid transition-colors duration-300">
        <div className="container mx-auto px-6">
          <SectionWrapper className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-6" style={{ color: 'goldenrod' }}>
              Our Team & Expertise
            </h2>
            <p className="text-slate-600 dark:text-white/60 max-w-2xl mx-auto text-lg">
              RERA-certified advisors, financial analysts and data scientists
              work together to deliver complete 360° support in:
            </p>
          </SectionWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {teamExpertise.map((item, idx) => (
              ...
              >
                <CometCard className="h-full">
                  <div className="bg-white dark:bg-black/50 p-8 rounded-xl border border-slate-200 dark:border-white/5 hover:border-amber-500/50 text-center shadow-lg dark:shadow-none transition-all duration-300 cursor-pointer group h-full">
                    <motion.div 
                      className="w-16 h-16 bg-amber-50 dark:bg-amber-900/20 rounded-full flex items-center justify-center mx-auto mb-6 border-2 border-amber-500/50 transition-all duration-300"
                      whileHover={{ 
                        scale: 1.15,
                        boxShadow: "0 0 30px rgba(218, 165, 32, 0.4), 0 0 50px rgba(255, 215, 0, 0.2)",
                      }}
                    ...
                    <h3 className="text-slate-800 dark:text-white font-medium text-sm leading-relaxed">
                      {item.title}
                    </h3>
                  </div>
                </CometCard>
      ...
      <SectionWrapper className="py-24 bg-white dark:bg-luxury-black border-y border-slate-200 dark:border-white/5 transition-colors duration-300">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-4xl  text-slate-900 dark:text-white text-center mb-12 font-bold" style={{ color: 'goldenrod' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {promises.map((promise, idx) => (
              ...
              >
                <CometCard className="h-full">
                  <div className="bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 dark:from-amber-900/30 dark:via-yellow-900/20 dark:to-orange-900/20 p-8 rounded-xl border border-amber-200 dark:border-amber-500/30 shadow-lg dark:shadow-none hover:border-amber-400 dark:hover:border-amber-400/50 transition-all duration-300 h-full cursor-pointer group hover:shadow-xl">
                    <motion.div 
                      className="mb-6 flex justify-center w-16 h-16 rounded-full border-2 border-amber-500/50 bg-gradient-to-br from-amber-100 to-yellow-100 dark:from-amber-500/20 dark:to-yellow-500/20 mx-auto items-center transition-all duration-300"
                      whileHover={{ 
                        scale: 1.15,
                        boxShadow: "0 0 30px rgba(218, 165, 32, 0.4), 0 0 50px rgba(255, 215, 0, 0.2)",
                      }}
                    >
                      <promise.icon className="w-8 h-8" style={{ color: 'goldenrod' }} strokeWidth={1.6} />
                    </motion.div>
                    <p className="text-slate-800 dark:text-white/90 font-medium text-sm leading-relaxed text-center">
                      {promise.text}
                    </p>
                  </div>
                </CometCard>
      ...
      <SectionWrapper className="py-24 container mx-auto px-6 bg-slate-50 dark:bg-luxury-charcoal transition-colors duration-300">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-brand-600 dark:text-brand-400 mb-8" style={{ color: 'goldenrod' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 pt-8">
            ...
            >
              ...
              <p className="text-slate-600 dark:text-white/70">
                We champion projects with green certifications and community
                value, encouraging investments that balance profitability and
                purpose.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 dark:text-white/70">
                Through our UAE and India network, we serve individual
                investors, HNIs, and corporates. We regularly host Investor
                Workshops and Roadshows to educate buyers entering the UAE
                market.
              </p>
            </motion.div>
          </div>
      ...
      <SectionWrapper className="py-24 bg-white dark:bg-luxury-black transition-colors duration-300">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl  text-slate-900 dark:text-white text-center mb-16">
            Our Leadership
          </h2>
      ...
      <ContactSection 
        title="Looking Ahead"
        subtitle="We will continue building analytics tools and AI platforms to make advisory more accurate and accessible. As the UAE transforms into an AI-first economy, Ridhira Realty will remain your bridge between intelligence and investment."
      />
    </main>
  );
};
